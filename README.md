...
- Track XP, streaks, daily goals, course mastery, and checkpoint badges locally in your browser.
...
The app is free, open source, and client-only. No account or cloud service is required; progress stays in the learner's browser and can be exported as a backup.
