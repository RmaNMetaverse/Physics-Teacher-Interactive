...
Physics Teacher Interactive contains 16 open courses: the complete 24-mission Foundations course, fifteen five-mission starter courses, fifteen culminating checkpoints (114 missions total), and 17 layered mathematics tutorials. The original science-course review date is **2026-09-09**, and its source link audit was completed on **2026-09-11**. Electronics and Arduino/ESP32 teaching references were consulted for the **2026-09-15** addition. These dates define editorial snapshots, not a claim of exhaustive coverage.
...
For the new Electronics and board starter paths, consulted primary references include [OpenStax Ohm's law](https://openstax.org/books/university-physics-volume-2/pages/9-4-ohms-law), [series and parallel resistors](https://openstax.org/books/university-physics-volume-2/pages/10-2-resistors-in-series-and-parallel), [Kirchhoff's rules](https://openstax.org/books/university-physics-volume-2/pages/10-3-kirchhoffs-rules), [Arduino built-in examples](https://docs.arduino.cc/built-in-examples/), the [Arduino language reference](https://docs.arduino.cc/language-reference/), and [Espressif GPIO documentation](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-reference/peripherals/gpio.html). Board-specific wiring and electrical limits still require the datasheet for the exact hardware used.
